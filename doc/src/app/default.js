...
return Magix.View.extend({
    tmpl: "<div id=\"sidebar\">\n    Magix<span style=\"font-size:10px\">(3.0)</span><ul class=\"toc_section\"><li><a href=\"#!/index\" mx-click=\"to({to:'download'})\">项目地址</a></li><li><a href=\"#!/index\" mx-click=\"to({to:'modules'})\">模块定制</a></li><li><a href=\"../project/\">示例项目</a></li><li><a href=\"#!/index\" mx-click=\"to({to:'tool'})\">编译工具</a></li><li><a href=\"#!/index\" mx-click=\"to({to:'vom'})\">调试插件</a></li></ul><hr /><%for(var i=0;i<list.length;i++){%><%var o=list[i]%><div mx-vframe=\"true\" mx-view=\"app/menu?name=<%=o.name%>\"></div><%}%></div><div class=\"container\" id=\"container\"><div mx-vframe=\"true\" mx-view=\"app/modules\"></div><%for(var i=0;i<list.length;i++){%><%var o=list[i]%><div mx-vframe=\"true\" mx-view=\"app/class?name=<%=o.name%>\"></div><%}%></div>",
    adjust: function() {
