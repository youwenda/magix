...
KISSY.add('magix', function (S, SE, Node, DOM) {
    ...
    var State_IsObserveChanged = function (view, keys, r) {
        ...
        if (oKeys) {
            for (var _a = 0, oKeys_1 = oKeys; _a < oKeys_1.length; _a++) {
                ok = oKeys_1[_a];
                r = G_Has(keys, ok);
                if (r)
                    break;
    ...
    var Dispatcher_Update = function (vframe, stateKeys, view, isChanged, cs, c) {
        if (vframe && vframe['$a'] != Dispatcher_UpdateTag &&
            ...
            cs = vframe.children();
            for (var _a = 0, cs_1 = cs; _a < cs_1.length; _a++) {
                c = cs_1[_a];
    ...
    G_Assign(Vframe[G_PROTOTYPE], MEvent, {
        ...
        mountZone: function (zoneId, inner /*,keepPreHTML*/) {
            ...
            for (var _b = 0, vframes_1 = vframes; _b < vframes_1.length; _b++) {
                vf = vframes_1[_b];
    ...
    var Body_FindVframeInfo = function (current, eventType) {
        ...
        if ((match && !match.v) || Body_SearchSelectorEvents[eventType]) {
            ...
            if (!view) { //先找最近的vframe
                ...
                for (var _a = 0, vfs_2 = vfs; _a < vfs_2.length; _a++) {
                    info = vfs_2[_a];
    ...
    var Body_DOMEventProcessor = function (domEvent) {
        ...
        while (target != G_DOCBODY) {
            ...
            if (eventInfos.length) {
                arr = [];
                for (var _a = 0, eventInfos_1 = eventInfos; _a < eventInfos_1.length; _a++) {
                    var _b = eventInfos_1[_a], v = _b.v, r = _b.r, n = _b.n, i = _b.i;
                    if (!v && DEBUG) {
 ...
 */
    ...
    var Updater_Digest = function (updater, digesting) {
        ...
        if (changed &&
            ...
            for (var _a = 0, _b = ref.d; _a < _b.length; _a++) {
                vdom = _b[_a];
                vdom[0].id = vdom[1];
            }
    ...
    G_Assign(Updater[G_PROTOTYPE], {
        ...
        digest: function (data, resolve) {
            var me = this.set(data), digesting = me['$d'];
            /*
                view:
                <div>
    ...
    var View_IsObserveChanged = function (view) {
        ...
        if (loc.f) {
            ...
            if (!res && loc.k) {
                ...
                for (var _a = 0, _b = loc.k; _a < _b.length; _a++) {
                    i = _b[_a];
                    res = G_Has(params, i);
                    if (res)
                        break;
 ...
 */
     ...
     */
    Magix.Base = G_NOOP;
    S.add(MxGlobalView, function () { return View.extend(); });
    //////////////////////// Shim ////////////////////////
    // Magix API
    ...
    Magix.local = function (key, value) {
        ...
        switch (args.length) {
            case 0:
                return G_Assign({}, __local);
                break;
            case 1:
                if (typeof key === 'string') {
                    return __local[key];
                }
                S.each(key, function (v, k) { return __local[k] = v; });
                break;
            case 2:
    ...
    Magix.tmpl.get = function (moduleId) { return __tmpl[moduleId]; };
    Magix.cache = function () {
        var args = [];
        for (var _a = 0; _a < arguments.length; _a++) {
            args[_a] = arguments[_a];
        }
    ...
    var Router_Parse = function Router_Parse(href) {
        ...
        var srcQuery, srcHash, query, hash, params;
        if (!result) {
            srcQuery = href.replace(Router_TrimHashReg, G_EMPTY);
            srcHash = href.replace(Router_TrimQueryReg, G_EMPTY);
            query = G_ParseUri(srcQuery);
    ...
    var Dispatcher_Update = function (vframe, stateKeys, view, isChanged, cs, c) {
        if (vframe && vframe['$a'] != Dispatcher_UpdateTag &&
            ...
            for (var _a = 0, cs_2 = cs; _a < cs_2.length; _a++) {
                c = cs_2[_a];
                Dispatcher_Update(Vframe_Vframes[c], stateKeys);
            }
        }
    };
    var origVframeAdd = Vframe_AddVframe;
    Vframe_AddVframe = function (id, vf) {
        origVframeAdd(id, vf);
        vf.on('created', function (e) { return vf.invoke('fire', ['created', e]); });
        vf.on('alter', function (e) { return vf.invoke('fire', ['alter', e]); });
    };
    ...
    Vframe.owner = Vframe;
    var MxEvent = /\bmx-(?!view|vframe|ssid|guid|dep|owner)([a-zA-Z]+)\s*=\s*['"]*/g;
    var VframeNoopProto = (function () {
        var r = {};
        var prop = Vframe[G_PROTOTYPE];
        for (var p in prop) {
            if (G_Has(prop, p)) {
    ...
    var origUnmountView = Vframe[G_PROTOTYPE].unmountView;
    G_Assign(Vframe[G_PROTOTYPE], {
            ...
            if (node && view) {
                ...
                G_Require(view, function (TView) {
                    if (sign == me['$g']) { //有可能在view载入后，vframe已经卸载了
                        ...
                        view = new TView(id, me, params, ctors);
                        if (DEBUG) {
                            var viewProto_2 = TView.prototype;
                            var importantProps_2 = {
                                id: 1,
                                updater: 1,
                                owner: 1,
                                '$l': 1,
        ...
        */
        ...
        mountZone: function (zoneId, viewInitParams, inner /*,keepPreHTML*/) {
            ...
            me['$d'] = 1; //hold fire creted
            //me.unmountZone(zoneId, 1); 不去清理，详情见：https://github.com/thx/magix/issues/27
            for (var _b = 0, vframes_2 = vframes; _b < vframes_2.length; _b++) {
                vf = vframes_2[_b];
                if (!vf['$b']) { //防止嵌套的情况下深层的view被反复实例化
                    id = IdIt(vf);
                    vf['$b'] = 1;
    ...
    Magix.VOM = Vframe;
    // View
    var View_ExtendEvents = function (ViewProto, events) {
    ...
    var View_FixEvents = function (View, events) {
    ...
    var origViewPrepare = View_Prepare;
    View_Prepare = function (View) {
        var set = View[G_SPLITER];
        var prop = View[G_PROTOTYPE];
    ...
    var Body_FindVframeInfo = function (current, eventType) {
        ...
        if ((match && !match.v) || Body_SearchSelectorEvents[eventType]) {
            ...
            if (!view) { //先找最近的vframe
                ...
                for (var _a = 0, vfs_4 = vfs; _a < vfs_4.length; _a++) {
                    info = vfs_4[_a];
                    if (!(tempId = Body_RangeVframes[selectorVfId])) {
                        tempId = Body_RangeVframes[selectorVfId] = {};
                    }
    ...
    var Body_DOMEventProcessor = function (domEvent) {
        ...
        var params, arr = [];
        // 记录target的id
        var targetId = IdIt(target);
        while (target != G_DOCBODY) {
            eventInfos = Body_FindVframeInfo(target, type);
            if (eventInfos.length) {
                arr = [];
                for (var _a = 0, eventInfos_2 = eventInfos; _a < eventInfos_2.length; _a++) {
                    var _b = eventInfos_2[_a], v = _b.v, r = _b.r, n = _b.n, e = _b.e, i = _b.i, p = _b.p;
                    if (!v && DEBUG) {
                        return Magix_Cfg.error(Error("bad " + type + ":" + r));
                    }
                    if (lastVfId != v) {
    ...
    S.add('magix/magix', function () { Magix['$|_attrForTest_|$priFun$|_attrForTest_|$']={'set-G_NOOP':function(fun){ var ori=G_NOOP;G_NOOP=fun; return ori;},'set-G_Id':function(fun){ var ori=G_Id;G_Id=fun; return ori;},'set-G_GetById':function(fun){ var ori=G_GetById;G_GetById=fun; return ori;},'set-G_IsPrimitive':function(fun){ var ori=G_IsPrimitive;G_IsPrimitive=fun; return ori;},'set-G_Set':function(fun){ var ori=G_Set;G_Set=fun; return ori;},'set-G_NodeIn':function(fun){ var ori=G_NodeIn;G_NodeIn=fun; return ori;},'set-G_Assign':function(fun){ var ori=G_Assign;G_Assign=fun; return ori;},'set-G_Keys':function(fun){ var ori=G_Keys;G_Keys=fun; return ori;},'set-View_ApplyStyle':function(fun){ var ori=View_ApplyStyle;View_ApplyStyle=fun; return ori;},'set-IdIt':function(fun){ var ori=IdIt;IdIt=fun; return ori;},'set-G_ToTry':function(fun){ var ori=G_ToTry;G_ToTry=fun; return ori;},'set-G_Has':function(fun){ var ori=G_Has;G_Has=fun; return ori;},'set-G_TranslateData':function(fun){ var ori=G_TranslateData;G_TranslateData=fun; return ori;},'set-Magix_CacheSort':function(fun){ var ori=Magix_CacheSort;Magix_CacheSort=fun; return ori;},'set-G_Cache':function(fun){ var ori=G_Cache;G_Cache=fun; return ori;},'set-G_Require':function(fun){ var ori=G_Require;G_Require=fun; return ori;},'set-G_DOMGlobalProcessor':function(fun){ var ori=G_DOMGlobalProcessor;G_DOMGlobalProcessor=fun; return ori;},'set-G_DOMEventLibBind':function(fun){ var ori=G_DOMEventLibBind;G_DOMEventLibBind=fun; return ori;},'set-Magix_ParamsFn':function(fun){ var ori=Magix_ParamsFn;Magix_ParamsFn=fun; return ori;},'set-G_ParseUri':function(fun){ var ori=G_ParseUri;G_ParseUri=fun; return ori;},'set-G_ToUri':function(fun){ var ori=G_ToUri;G_ToUri=fun; return ori;},'set-G_ToMap':function(fun){ var ori=G_ToMap;G_ToMap=fun; return ori;},'set-G_ParseExpr':function(fun){ var ori=G_ParseExpr;G_ParseExpr=fun; return ori;},'set-State_IsObserveChanged':function(fun){ var ori=State_IsObserveChanged;State_IsObserveChanged=fun; return ori;},'set-SetupKeysRef':function(fun){ var ori=SetupKeysRef;SetupKeysRef=fun; return ori;},'set-TeardownKeysRef':function(fun){ var ori=TeardownKeysRef;TeardownKeysRef=fun; return ori;},'set-GetParam':function(fun){ var ori=GetParam;GetParam=fun; return ori;},'set-Router_UpdateHash':function(fun){ var ori=Router_UpdateHash;Router_UpdateHash=fun; return ori;},'set-Router_Update':function(fun){ var ori=Router_Update;Router_Update=fun; return ori;},'set-Router_Bind':function(fun){ var ori=Router_Bind;Router_Bind=fun; return ori;},'set-Router_AttachViewAndPath':function(fun){ var ori=Router_AttachViewAndPath;Router_AttachViewAndPath=fun; return ori;},'set-Router_GetChged':function(fun){ var ori=Router_GetChged;Router_GetChged=fun; return ori;},'set-Router_Parse':function(fun){ var ori=Router_Parse;Router_Parse=fun; return ori;},'set-Router_Diff':function(fun){ var ori=Router_Diff;Router_Diff=fun; return ori;},'set-Dispatcher_Update':function(fun){ var ori=Dispatcher_Update;Dispatcher_Update=fun; return ori;},'set-Dispatcher_NotifyChange':function(fun){ var ori=Dispatcher_NotifyChange;Dispatcher_NotifyChange=fun; return ori;},'set-Vframe_NotifyCreated':function(fun){ var ori=Vframe_NotifyCreated;Vframe_NotifyCreated=fun; return ori;},'set-Vframe_NotifyAlter':function(fun){ var ori=Vframe_NotifyAlter;Vframe_NotifyAlter=fun; return ori;},'set-Vframe_TranslateQuery':function(fun){ var ori=Vframe_TranslateQuery;Vframe_TranslateQuery=fun; return ori;},'set-Vframe_Root':function(fun){ var ori=Vframe_Root;Vframe_Root=fun; return ori;},'set-Vframe_AddVframe':function(fun){ var ori=Vframe_AddVframe;Vframe_AddVframe=fun; return ori;},'set-Vframe_RunInvokes':function(fun){ var ori=Vframe_RunInvokes;Vframe_RunInvokes=fun; return ori;},'set-Vframe_RemoveVframe':function(fun){ var ori=Vframe_RemoveVframe;Vframe_RemoveVframe=fun; return ori;},'set-Vframe':function(fun){ var ori=Vframe;Vframe=fun; return ori;},'set-Body_FindVframeInfo':function(fun){ var ori=Body_FindVframeInfo;Body_FindVframeInfo=fun; return ori;},'set-Body_DOMEventProcessor':function(fun){ var ori=Body_DOMEventProcessor;Body_DOMEventProcessor=fun; return ori;},'set-Body_DOMEventBind':function(fun){ var ori=Body_DOMEventBind;Body_DOMEventBind=fun; return ori;},'set-I_UnmountVframs':function(fun){ var ori=I_UnmountVframs;I_UnmountVframs=fun; return ori;},'set-I_GetNode':function(fun){ var ori=I_GetNode;I_GetNode=fun; return ori;},'set-I_SetAttributes':function(fun){ var ori=I_SetAttributes;I_SetAttributes=fun; return ori;},'set-I_SpecialDiff':function(fun){ var ori=I_SpecialDiff;I_SpecialDiff=fun; return ori;},'set-I_GetCompareKey':function(fun){ var ori=I_GetCompareKey;I_GetCompareKey=fun; return ori;},'set-I_SetChildNodes':function(fun){ var ori=I_SetChildNodes;I_SetChildNodes=fun; return ori;},'set-I_SetNode':function(fun){ var ori=I_SetNode;I_SetNode=fun; return ori;},'set-Updater_Digest':function(fun){ var ori=Updater_Digest;Updater_Digest=fun; return ori;},'set-Updater':function(fun){ var ori=Updater;Updater=fun; return ori;},'set-processMixinsSameEvent':function(fun){ var ori=processMixinsSameEvent;processMixinsSameEvent=fun; return ori;},'set-View_DestroyAllResources':function(fun){ var ori=View_DestroyAllResources;View_DestroyAllResources=fun; return ori;},'set-View_DestroyResource':function(fun){ var ori=View_DestroyResource;View_DestroyResource=fun; return ori;},'set-View_WrapMethod':function(fun){ var ori=View_WrapMethod;View_WrapMethod=fun; return ori;},'set-View_DelegateEvents':function(fun){ var ori=View_DelegateEvents;View_DelegateEvents=fun; return ori;},'set-View_MergeMixins':function(fun){ var ori=View_MergeMixins;View_MergeMixins=fun; return ori;},'set-View_Prepare':function(fun){ var ori=View_Prepare;View_Prepare=fun; return ori;},'set-View_IsObserveChanged':function(fun){ var ori=View_IsObserveChanged;View_IsObserveChanged=fun; return ori;},'set-View':function(fun){ var ori=View;View=fun; return ori;},'set-Bag':function(fun){ var ori=Bag;Bag=fun; return ori;},'set-Service_CacheDone':function(fun){ var ori=Service_CacheDone;Service_CacheDone=fun; return ori;},'set-Service_Task':function(fun){ var ori=Service_Task;Service_Task=fun; return ori;},'set-Service_Send':function(fun){ var ori=Service_Send;Service_Send=fun; return ori;},'set-Service':function(fun){ var ori=Service;Service=fun; return ori;},'set-Manager_DefaultCacheKey':function(fun){ var ori=Manager_DefaultCacheKey;Manager_DefaultCacheKey=fun; return ori;},'set-Manager_ClearCache':function(fun){ var ori=Manager_ClearCache;Manager_ClearCache=fun; return ori;},'set-Router_Parse':function(fun){ var ori=Router_Parse;Router_Parse=fun; return ori;},'set-Dispatcher_Update':function(fun){ var ori=Dispatcher_Update;Dispatcher_Update=fun; return ori;},'set-View_ExtendEvents':function(fun){ var ori=View_ExtendEvents;View_ExtendEvents=fun; return ori;},'set-View_FixEvents':function(fun){ var ori=View_FixEvents;View_FixEvents=fun; return ori;},'set-View_WrapMethod':function(fun){ var ori=View_WrapMethod;View_WrapMethod=fun; return ori;},'set-Body_FindVframeInfo':function(fun){ var ori=Body_FindVframeInfo;Body_FindVframeInfo=fun; return ori;},'set-Body_DOMEventProcessor':function(fun){ var ori=Body_DOMEventProcessor;Body_DOMEventProcessor=fun; return ori;},'set-G_DOMEventLibBind':function(fun){ var ori=G_DOMEventLibBind;G_DOMEventLibBind=fun; return ori;},'set-View_IsObserveChanged':function(fun){ var ori=View_IsObserveChanged;View_IsObserveChanged=fun; return ori;},'set-PrepareVOMMessage':function(fun){ var ori=PrepareVOMMessage;PrepareVOMMessage=fun; return ori;},'set-PostMessage':function(fun){ var ori=PostMessage;PostMessage=fun; return ori;},'set-View_SetEventOwner':function(fun){ var ori=View_SetEventOwner;View_SetEventOwner=fun; return ori;}};
    Magix['$|_attrForTest_|$priVar$|_attrForTest_|$']={$:$,G_IsObject:G_IsObject,G_IsArray:G_IsArray,G_COUNTER:G_COUNTER,G_EMPTY:G_EMPTY,G_EMPTY_ARRAY:G_EMPTY_ARRAY,G_COMMA:G_COMMA,G_NULL:G_NULL,G_WINDOW:G_WINDOW,G_Undefined:G_Undefined,G_DOCUMENT:G_DOCUMENT,G_DOC:G_DOC,Timeout:Timeout,G_CHANGED:G_CHANGED,G_CHANGE:G_CHANGE,G_PAGE_UNLOAD:G_PAGE_UNLOAD,G_VALUE:G_VALUE,G_Tag_Key:G_Tag_Key,G_Tag_Attr_Key:G_Tag_Attr_Key,G_Tag_View_Key:G_Tag_View_Key,G_HashKey:G_HashKey,JSONStringify:JSONStringify,G_DOCBODY:G_DOCBODY,G_SPLITER:G_SPLITER,Magix_StrObject:Magix_StrObject,G_PROTOTYPE:G_PROTOTYPE,G_PARAMS:G_PARAMS,G_PATH:G_PATH,G_MX_VIEW:G_MX_VIEW,Magix_PathTrimParamsReg:Magix_PathTrimParamsReg,Magix_ParamsReg:Magix_ParamsReg,Magix_IsParam:Magix_IsParam,MxGlobalView:MxGlobalView,Magix_Cfg:Magix_Cfg,Magix_HasProp:Magix_HasProp,Header:Header,G_Extend:G_Extend,G_TargetMatchSelector:G_TargetMatchSelector,Specials:Specials,Magix_PathToObjCache:Magix_PathToObjCache,Magix_Booted:Magix_Booted,Magix_ParamsObjectTemp:Magix_ParamsObjectTemp,G_ParseCache:G_ParseCache,Magix:Magix,MEvent:MEvent,State_AppData:State_AppData,State_AppDataKeyRef:State_AppDataKeyRef,State_ChangedKeys:State_ChangedKeys,State_DataIsChanged:State_DataIsChanged,State_DataWhereSet:State_DataWhereSet,State:State,Router_VIEW:Router_VIEW,Router_HrefCache:Router_HrefCache,Router_ChgdCache:Router_ChgdCache,Router_WinLoc:Router_WinLoc,Router_LastChanged:Router_LastChanged,Router_Silent:Router_Silent,Router_LLoc:Router_LLoc,Router_TrimHashReg:Router_TrimHashReg,Router_TrimQueryReg:Router_TrimQueryReg,Router_Edge:Router_Edge,Router_Hashbang:Router_Hashbang,Router_PNR_Routers:Router_PNR_Routers,Router_PNR_Rewrite:Router_PNR_Rewrite,DefaultTitle:DefaultTitle,Router:Router,Dispatcher_UpdateTag:Dispatcher_UpdateTag,Vframe_RootVframe:Vframe_RootVframe,Vframe_GlobalAlter:Vframe_GlobalAlter,Vframe_Vframes:Vframe_Vframes,Vframe_Cache:Vframe_Cache,Body_EvtInfoCache:Body_EvtInfoCache,Body_EvtInfoReg:Body_EvtInfoReg,Body_RootEvents:Body_RootEvents,Body_SearchSelectorEvents:Body_SearchSelectorEvents,Body_RangeEvents:Body_RangeEvents,Body_RangeVframes:Body_RangeVframes,Body_Guid:Body_Guid,I_SVGNS:I_SVGNS,I_WrapMap:I_WrapMap,I_RTagName:I_RTagName,I_Doc:I_Doc,I_Base:I_Base,I_Specials:I_Specials,View_EvtMethodReg:View_EvtMethodReg,View_Ctors:View_Ctors,View_Globals:View_Globals,ViewProto:ViewProto,G_Type:G_Type,G_Now:G_Now,Service_FetchFlags_ONE:Service_FetchFlags_ONE,Service_FetchFlags_ALL:Service_FetchFlags_ALL,Service_Manager:Service_Manager,__local:__local,__tmpl:__tmpl,__deprecated:__deprecated,G_LocationChanged:G_LocationChanged,G_Location:G_Location,origVframeAdd:origVframeAdd,MxEvent:MxEvent,VframeNoopProto:VframeNoopProto,origUnmountView:origUnmountView,origViewPrepare:origViewPrepare,View_Ctors:View_Ctors,Body_EvtInfoReg:Body_EvtInfoReg,EvtParamsReg:EvtParamsReg,Body_RootEvents:Body_RootEvents,Body_SearchSelectorEvents:Body_SearchSelectorEvents,Body_RangeEvents:Body_RangeEvents,Body_RangeVframes:Body_RangeVframes,Body_Guid:Body_Guid,WEvent:WEvent,VOMEventsObject:VOMEventsObject,View_ScopeReg:View_ScopeReg,origObserveLocation:origObserveLocation};
    return Magix; });
    S.add('magix/event', function () { return Magix.Event; });
    S.add('magix/router', function () { return Router; });
    S.add('magix/vframe', function () { return Vframe; });
    S.add('magix/vom', function () { return Vframe; });
    S.add('magix/view', function () { return View; });
    S.add('mxext/view', function () { return View; });
    //////////////////////// Shim ////////////////////////
    /* eslint-disable */
    /**
    ...
    KISSY.add("mxext/model", function (S, Magix) {
        ...
        */
        ...
        Magix.mix(Model.prototype, {
             ...
             */
            url: function (uri) {
                var self = this, url = self.get('url'), uris;
