...
tmplData:[{"keys":["checkedFields"],"selector":"tr[mx-guid=\"xf351-\u001f\"]"},{"guid":2,"keys":["checkedFields"],"tmpl":"<%for(var i=0;i<20;i++){%><tr><td>测试<%=Math.random()%></td><td><div class=\"operation\"><a href=\"javascript:;\" mx-click=\"showMore()\">更多</a></div></td></tr><%}%>","selector":"tbody[mx-guid=\"xf352-\u001f\"]"}],
    ctor: function() {
        MoreLinks.setup();
