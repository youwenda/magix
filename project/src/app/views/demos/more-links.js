...
return Magix.View.extend({
    tmpl: "<div class=\"mp-599-wrapper\"><button class=\"btn\" mx-click=\"showBatch()\">批量操作</button><table class=\"table\"><thead><tr mx-guid=\"xf351-\u001f\">@1-\u001f</tr></thead><tbody mx-guid=\"xf352-\u001f\">@2-\u001f</tbody></table></div><ul class=\"mp-599-list mp-599-none\" id=\"batch_<%=id%>\"><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">test1</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">test2</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">test3</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">test4</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">test5</li></ul><ul class=\"mp-599-list mp-599-none\" id=\"more_<%=id%>\"><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">more-test1</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">more-test2</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">more-test3</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">more-test4</li><li mx-mouseover=\"hover()\" mx-mouseout=\"hover()\">more-test5</li></ul>",
tmplData:[{"guid":1,"keys":["checkedFields"],"tmpl":"<th>名称</th><th>操作</th>","selector":"tr[mx-guid=\"xf351-\u001f\"]","attrs":[]},{"guid":2,"keys":["checkedFields"],"tmpl":"\n            <%for(var i=0;i<20;i++){%>\n            <tr><td>测试<%=Math.random()%></td><td><div class=\"operation\"><a href=\"javascript:;\" mx-click=\"showMore()\">更多</a></div></td></tr>\n            <%}%>\n        ","selector":"tbody[mx-guid=\"xf352-\u001f\"]","attrs":[]}],
    ctor: function() {
        MoreLinks.setup();
