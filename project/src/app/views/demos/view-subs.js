...
return Form.extend({
    tmpl: "<div class=\"mp-514-wrapper\"><div class=\"mp-514-form-item\"><div class=\"mp-514-title\">创意标题</div><div class=\"mp-514-content\"><input class=\"input\" /></div></div><div class=\"mp-514-form-item\"><div class=\"mp-514-title\">创意类型</div><div class=\"mp-514-content\" id=\"types_<%=id%>\"></div></div><div id=\"type_vf_<%=id%>\" mx-vframe=\"true\"></div><button class=\"btn\" mx-click=\"save();\">保存</button></div>",
    render: function() {
        var me = this;
        var creative = {
            name: 'test',
