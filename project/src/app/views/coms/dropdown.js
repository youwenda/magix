...
return Magix.View.extend({
    tmpl: "<div class=\"mp-5bd-wrapper\"><div id=\"d1_<%=viewId%>\" class=\"mp-5bd-dropdown\"></div><div id=\"d2_<%=viewId%>\" class=\"mp-5bd-dropdown\"></div><button mx-click=\"changeService()\" class=\"btn btn-size25\">切换数据源</button><div id=\"d3_<%=viewId%>\" class=\"mp-5bd-dropdown mp-5bd-bottom\"></div><div class=\"mp-5bd-dropdown\" mx-vframe=\"true\" mx-view=\"coms/dropdown/index?source=script&selected=<%=d2Id%>\" mx-guid=\"xb411-\u001f\">@1-\u001f</div><br /><div class=\"mp-5bd-dropdown\" id=\"p_<%=viewId%>\"></div><div class=\"mp-5bd-dropdown\" mx-vframe=\"true\" mx-view=\"coms/dropdown/index?source=script&selected=<%=citySelected%>\" mx-guid=\"xb412-\u001f\">@2-\u001f</div></div>",
